...
class HeaderItemDecoration(private val listener: StickyHeaderInterface) : RecyclerView.ItemDecoration() {
    ...
    private fun getChildInContact(parent: RecyclerView, contactPoint: Int): View? {
        ...
        for (i in 0 until parent.childCount) {
            ...
            if (child.bottom + lp.bottomMargin > contactPoint) {
                if (child.top - lp.topMargin <= contactPoint) {
